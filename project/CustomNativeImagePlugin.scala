package customsbtnativeimage

// Copy of https://github.com/scalameta/sbt-native-image/blob/62631b24eebc84a8ba4b8118edd084dcad2acd98/plugin/src/main/scala/sbtnativeimage/NativeImagePlugin.scala
// with nativeImageManifest added
...
object CustomNativeImagePlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    lazy val nativeImageManifest: TaskKey[File] = taskKey[File](
      ""
    )
